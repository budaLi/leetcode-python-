...
def GetSearchContent(key):
    ...
    start_date = datetime.datetime(2018, 11, 24, 0)
    end_date = datetime.datetime(2018, 11, 26, 0)
...
def getContent():
    ...
    df.to_excel(r'C:\Users\lenovo\PycharmProjects\leetcode-python-\python开发\24-26.xls', index=0)
...
if __name__ == '__main__':
    ...
    username = '17836210398'  # 填写用户名
    password = '123456789'  # 填写密码
