...
# @FileName: sample.py
# @Software: PyCharm
from 企业微信.被动回复 import WXBizMsgCrypt
...
if __name__ == "__main__":
     ...
     *企业开启回调模式时，企业号会向验证url发送一个get请求 
     假设点击验证时，企业收到类似请求：
     * GET /cgi-bin/wxpush?msg_signature=012bc692d0a58dd4b10f8dfe5c4ac00ae211ebeb&timestamp=1476416373&nonce=47744683&echostr=fsi1xnbH4yQh0+PJxcOdhhK6TDXkjMyhEPA7xB2TGz6b+g7xyAbEkRxN/3cNXW9qdqjnoVzEtpbhnFyq6SVHyA== 
    ...
    # sVerifyMsgSig=requests.getPar("msg_signature")
